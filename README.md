...
SousChef is a household food operating system — pantry inventory, receipt and photo scanning, Brain 5.2 AI Impact Suite, Kitchen Learning Engine v7.4, **568,510** structured recipes, Training Kitchen & Kitchen Academy, nine-tool Clara router, multi-course meal planning, Hosting Studio, site search, Cook Together households, and a 400+ node knowledge graph.
...
- **Recipe Library** — 568,000+ recipes across 48 cuisines, 10 course types; pantry match at 0 credits
...
| Knowledge | 400+ JSON nodes + 568k dish corpus in `data/ai/` |
...
npm run knowledge:dishes     # Regenerate 568k recipe corpus (v4 signature variants)
