    ...
    return (
      <section className="card bg-stainless-100 border-steel">
        <div className="flex items-start gap-3">
          <div className="w-10 h-10 rounded-full bg-stainless-200 flex items-center justify-center shrink-0">
            <Users className="text-chef-muted" size={20} />
          </div>
          <div className="flex-1">
            ...
            <Link to="/cook" className="inline-flex items-center gap-1 text-sm font-medium text-chef-muted mt-3">
    ...
    <section className="card border-dashed border-2 border-steel bg-stainless-200/50">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <Link to="/settings" className="inline-block text-sm font-medium text-chef-muted mt-3">
